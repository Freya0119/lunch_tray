...
public class FragmentAccompanimentMenuBindingImpl extends FragmentAccompanimentMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        boolean viewModelAccompanimentNameEqualsViewModelMenuItemsBerriesName = false;
        boolean viewModelAccompanimentNameEqualsViewModelMenuItemsPicklesName = false;
        boolean viewModelAccompanimentNameEqualsViewModelMenuItemsBreadName = false;
        ...
        if ((dirtyFlags & 0x1bL) != 0) {
            ...
            if ((dirtyFlags & 0x19L) != 0) {
                    ...
                    if (viewModelAccompanimentName != null) {
                        // read viewModel.accompaniment.getValue().name.equals(viewModel.menuItems["bread"].name)
                        viewModelAccompanimentNameEqualsViewModelMenuItemsBreadName = viewModelAccompanimentName.equals(viewModelMenuItemsBreadName);
                        // read viewModel.accompaniment.getValue().name.equals(viewModel.menuItems["pickles"].name)
                        viewModelAccompanimentNameEqualsViewModelMenuItemsPicklesName = viewModelAccompanimentName.equals(viewModelMenuItemsPicklesName);
                        // read viewModel.accompaniment.getValue().name.equals(viewModel.menuItems["berries"].name)
                        viewModelAccompanimentNameEqualsViewModelMenuItemsBerriesName = viewModelAccompanimentName.equals(viewModelMenuItemsBerriesName);
                    }
        ...
        if ((dirtyFlags & 0x19L) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.berries, viewModelAccompanimentNameEqualsViewModelMenuItemsBerriesName);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.bread, viewModelAccompanimentNameEqualsViewModelMenuItemsBreadName);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.pickles, viewModelAccompanimentNameEqualsViewModelMenuItemsPicklesName);
        }
