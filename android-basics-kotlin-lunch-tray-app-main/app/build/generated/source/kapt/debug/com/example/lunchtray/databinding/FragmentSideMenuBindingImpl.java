...
public class FragmentSideMenuBindingImpl extends FragmentSideMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        boolean viewModelSideNameEqualsViewModelMenuItemsSoupName = false;
        boolean viewModelSideNameEqualsViewModelMenuItemsRiceName = false;
        ...
        boolean viewModelSideNameEqualsViewModelMenuItemsSaladName = false;
        ...
        boolean viewModelSideNameEqualsViewModelMenuItemsPotatoesName = false;
        ...
        if ((dirtyFlags & 0x1bL) != 0) {
            ...
            if ((dirtyFlags & 0x1aL) != 0) {
                    ...
                    if (viewModelSideName != null) {
                        // read viewModel.side.getValue().name.equals(viewModel.menuItems["soup"].name)
                        viewModelSideNameEqualsViewModelMenuItemsSoupName = viewModelSideName.equals(viewModelMenuItemsSoupName);
                        // read viewModel.side.getValue().name.equals(viewModel.menuItems["rice"].name)
                        viewModelSideNameEqualsViewModelMenuItemsRiceName = viewModelSideName.equals(viewModelMenuItemsRiceName);
                        // read viewModel.side.getValue().name.equals(viewModel.menuItems["salad"].name)
                        viewModelSideNameEqualsViewModelMenuItemsSaladName = viewModelSideName.equals(viewModelMenuItemsSaladName);
                        // read viewModel.side.getValue().name.equals(viewModel.menuItems["potatoes"].name)
                        viewModelSideNameEqualsViewModelMenuItemsPotatoesName = viewModelSideName.equals(viewModelMenuItemsPotatoesName);
                    }
        ...
        if ((dirtyFlags & 0x1aL) != 0) {
            ...
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.potatoes, viewModelSideNameEqualsViewModelMenuItemsPotatoesName);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.rice, viewModelSideNameEqualsViewModelMenuItemsRiceName);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.salad, viewModelSideNameEqualsViewModelMenuItemsSaladName);
            androidx.databinding.adapters.CompoundButtonBindingAdapter.setChecked(this.soup, viewModelSideNameEqualsViewModelMenuItemsSoupName);
        }
        if ((dirtyFlags & 0x19L) != 0) {
            // api target 1
